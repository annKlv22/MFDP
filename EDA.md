...
|-----|-----------------|-----------|
| Anthus pratensis | Луговой конёк | 24 |
...
|------------|----------|
| Видов | 33 |
| Сегментов всего | 2809 |
| Среднее на вид | 85.1 |
| Медиана | 72.0 |
| Минимум | 24 (Anthus pratensis) |
| Максимум | 185 (Turdus merula) |
| Соотношение max/min | 7.7× |
...
|--------|-------|------|
| < 30 сегментов | 1 | 3% |
| 30–60 сегментов | 12 | 36% |
| 60+ сегментов | 20 | 61% |

**Выводы для моделирования:**
- Дисбаланс умеренный (7.7×) 
- 61% видов имеют 60+ сегментов — датасет хорошо насыщен для дообучения 
...
Текущий результат: **2410 train / 399 val** (43 класса с учётом подвидов).
